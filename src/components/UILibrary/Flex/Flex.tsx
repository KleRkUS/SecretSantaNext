...
interface StyleProps {
    justifyContent?: 'space-between' | 'space-around' | 'flex-start' | 'center' | 'flex-end';
...
export const Flex = memo(({ children, ...otherProps }: FlexProps) => <SFlex {...otherProps}>{children}</SFlex>);
